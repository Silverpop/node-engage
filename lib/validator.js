module.exports = (function () {
    ...
    my.isEngagePod = function(val) {
        return ((my.isInteger(val) && val >= 0 && val <= 9) || val == 'a');
    };
    ...
    my.assertObject = function (val, name) {
        return _assertValue(my.isObject, 'an object', val, name);
    };
    ...
    my.assertEngagePod = function(val, name) {
        return _assertValue(
            my.isEngagePod,
            'an Engage pod id (integer between 0-9 or the string "a")',
            val,
            name
        );
    };
