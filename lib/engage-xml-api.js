...
var EngageXmlApi = function(engage, engageAuth) {
    ...
    function _makeXmlApiRequest(methodName, requestParams, cb) {
        ...
        postData = querystring.stringify({xml: js2xmlparser("Envelope", request, {useCDATA: true})});

        _engageAuth.makeRequest('/XMLAPI', 'POST', 'application/x-www-form-urlencoded; charset=UTF-8', postData, function(err, responseData) {
            var parser;
